...
enum class AbilityInput : uint8
{
	...
	WeaponAbility UMETA(DisplayName = "Use Weapon"), //This finally maps the fifth ability(here designated to be your weapon-ability, or auto-attack, or whatever) to action mapping "WeaponAbility".
